...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--which_model_netG', type=str, default='_UNetGenerator', help='selects model to use for netG')
        ...
        self.parser.add_argument('--dataset_mode', type=str, default='pair_gray', help='chooses how datasets are loaded. [unaligned | aligned | single]')
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='/data/lizx/RetinexGAN-edge/checkpoints', help='models are saved here')
        ...
        self.parser.add_argument('--display_port', type=int, default=8222, help='visdom port of the web display')
        ...
        self.parser.add_argument('--attention_D', action='store_true',help='use attention discriminator')
        ...
        self.parser.add_argument('--use_max', action='store_true', help='max operation')
        self.parser.add_argument('--use_edge', action='store_true', help='max operation')
        self.parser.add_argument('--img_decomposition', action='store_true', help='decomposes the input image into high and low frequency components')
        self.parser.add_argument('--use_senet', action='store_true', help='se-net')
        self.parser.add_argument('--attention_cbam', action='store_true', help='attention_cbam')
        self.parser.add_argument('--layers', type=int, default=4, help='layers')
        self.parser.add_argument('--activation', type=str, default='PReLU', help='activation')
        self.parser.add_argument('--drop_rate', type=int, default=0, help='drop_rate')
        self.parser.add_argument('--add_noise', action='store_false', help='add_noise')
        self.parser.add_argument('--weight', type=float, default=0.1, help='weight')
    ...
    def parse(self):
        ...
        #    args.device = torch.device('cuda:{}'.format(2) if torch.cuda.is_available() else 'cpu')
